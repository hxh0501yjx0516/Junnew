...
<table width="50%" align="center" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center"><table width="419" height="226" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center" background="<%=request.getContextPath() %>/html/images/error.jpg"><table width="388" height="194" border="0" cellpadding="0" cellspacing="0">
        	<tr>	
        		<td width="100" height="50"><img src="<%=request.getContextPath() %>/html/images/login_title.gif"></td>
        	</tr>
