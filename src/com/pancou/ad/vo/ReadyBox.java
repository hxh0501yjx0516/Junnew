...
public class ReadyBox implements Serializable {
	...
	private String showIpString;	//日流量控制	日流量控制：如 200,20110501|300,20110502|100,20110503(流量，日期) 日期格式yyyyMMdd
	...
	private int adCreativeLevel;	//创意轮播等级（>=0 并且 <100，即0-99）默认创意的等级不能让用户设定，程序自动赋值为0		
